...
class FavoriteMovieViewModel(private val mMovieCatalogueRepository: MovieCatalogueRepository) : ViewModel() {

    fun getFavoriteMovies(): LiveData<PagedList<MoviesModel>> = mMovieCatalogueRepository.getFavoriteMovies()
